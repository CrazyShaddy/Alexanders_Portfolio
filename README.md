...
# [Handwritten digits recognition in Python](https://github.com/AlexandersProjects/ml_number_recognition)
...
# [Pokemon comparison in R](https://github.com/AlexandersProjects/legendary_pokemon_comparison)
* Explored the data
* Controlled the data
...
# [Asteroid diameter prediction in Python](https://github.com/AlexandersProjects/Asteroid_Diameter_Prediction)
* Cleaned the data
* Explored the data
* Performed different prediction models:
  * Linear regression
...
# [Overfitting example in Python](https://github.com/AlexandersProjects/ueberanpassung_Beispiele)
* Used pipelines
...
# [Linear Regression in Python](https://github.com/AlexandersProjects/linear_regressions)
* performed:
  * linear regression
...
# [Height and weight Dataset with OOP in Python](https://github.com/CrazyShaddy/height_weight_analysis_and_prediction)
...
# [Exploratory Data Analysis in Python](https://github.com/CrazyShaddy/Exploratory-Data-Analysis)
...
# [Compound Interest calculator in Python](https://github.com/CrazyShaddy/Compound_Interest_Calculator)
